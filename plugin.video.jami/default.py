...
icon19a = 'special://home/addons/plugin.video.jami/resources/icon19a.png'
...
def main_list(params):
	...
	plugintools.add_item(title = "Daniel Tigre [BR]", url = base + "playlist/PLoaBAxtZve6nmFuNHCmIRLz_bo2aCD4wX/", thumbnail = icon19a, fanart = fan01, folder = True)
	...
	plugintools.add_item(title = "Team Hot Wheels [BR]", url = base + "playlist/PLsWbExGo1KPb-TTwpvyEDIZa51JUYLr9l/", thumbnail = icon22a, fanart = fan01, folder = True)
	...
	plugintools.add_item(title = "Irmãos Grimm [PT]", url = base + "playlist/PLaerdHbAdrDIIi3LuIIdCRGdFoHe3lS_D/", thumbnail = icon23a, fanart = fan01, folder = True)
