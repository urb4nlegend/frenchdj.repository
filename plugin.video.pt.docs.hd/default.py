...
def main_list(params):
	...
	plugintools.add_item(title = "[ Futuro - Teorias ]", url = base + "playlist/PLAg4T2da6qWwvAWWAcD4Pb-6sTrmKiOyf/", thumbnail = icon04, fanart = fan01, folder = True)
	...
	plugintools.add_item(title = "[ Era uma Vez ]", url = base + "playlist/PLAg4T2da6qWwLIP_kqJn5WIvZeqkg3aJ5/", thumbnail = icon12, fanart = fan01, folder = True)
