...
iconBA = 'special://home/addons/plugin.video.pt.docs.hd/resources/iconBA.png'
iconBB = 'special://home/addons/plugin.video.pt.docs.hd/resources/iconBB.png'
iconBC = 'special://home/addons/plugin.video.pt.docs.hd/resources/iconBC.png'
...
def main_list(params):
	...
	plugintools.add_item(title = "[ Portugal Media Center ]", url = base + "channel/UCb6fo8oH9phPpNjzNjc8MOg/", thumbnail = iconAA, fanart = fan01, folder = True)
	...
	plugintools.add_item(title = "[ Competição - Hooligans ]", url = base + "playlist/PLAg4T2da6qWxlyw4HD5t6bOt9n03nIHGa/", thumbnail = icon06, fanart = fan01, folder = True)
	plugintools.add_item(title = "[ Tendências - Paranóias ]", url = base + "playlist/PLAg4T2da6qWxSswYqS6gi4XYZ3qlz5Azo/", thumbnail = icon07, fanart = fan01, folder = True)
	plugintools.add_item(title = "[ Gangues - Prisões ]", url = base + "playlist/PLAg4T2da6qWxPpEjq9KWuGe6vF-DWbAiE/", thumbnail = icon08, fanart = fan01, folder = True)
	plugintools.add_item(title = "[ Biografias - Eventos ]", url = base + "playlist/PLAg4T2da6qWzUkstE50-E3rRnLCW9nX2Q/", thumbnail = icon09, fanart = fan01, folder = True)
	plugintools.add_item(title = "[ Cultos - Seitas ]", url = base + "playlist/PLAg4T2da6qWxPpEjq9KWuGe6vF-DWbAiE/", thumbnail = icon10, fanart = fan01, folder = True)
	...
	plugintools.add_item(title = "[ Acredite ou não ]", url = base + "channel/UCunqx90PNIv30uOgn0m4CTg/", thumbnail = iconBA, fanart = fan01, folder = True)
	plugintools.add_item(title = "[ Revolução Ciêntifica ]", url = base + "channel/UCPLBXvobTRvDjPy41y9hG8g/", thumbnail = iconBB, fanart = fan01, folder = True)
	plugintools.add_item(title = "[ Sem Legendas ]", url = base + "channel/UCn8zNIfYAQNdrFRrr8oibKw/", thumbnail = iconBC, fanart = fan01, folder = True)
