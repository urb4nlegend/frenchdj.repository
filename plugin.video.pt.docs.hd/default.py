...
def main_list(params):
	...
	plugintools.add_item(title = "[ Terremotos - Impactos ]", url = base + "playlist/PLAg4T2da6qWz9L4bxdK0jg4d01r50eM6P/", thumbnail = icon04, fanart = fan01, folder = True)
	plugintools.add_item(title = "[ Futuro - Teorias ]", url = base + "playlist/PLAg4T2da6qWwvAWWAcD4Pb-6sTrmKiOyf/", thumbnail = icon05, fanart = fan01, folder = True)
