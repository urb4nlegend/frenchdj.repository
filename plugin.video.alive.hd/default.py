...
alive_source = os.path.join(home, 'alive_source')
...
# Necessario para a funcionalidade de pesquisa dedicada do Alive.HD        
...
# Necessario para abrir os Favoritos do KODI que foram adicionados ao Alive.HD 
...
#                print 'setting as folder in link'
        ...
        if (not play_list) and not any(x in url for x in g_ignoreSetResolved) and not '$PLAYERPROXY$=' in url:
            if regexs:
