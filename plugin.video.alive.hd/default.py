...
def getSearchData(url,icon, data=None):
    ...
    if keyboard.isConfirmed():
        ...
        xbmcgui.Dialog().ok('Alive HD', 'Blank Searches are not allowed.')
        quit()
    fanart=''
    dontLink=False
    os.path.join(home, 'resources', 'fanart.gif')
...
#            ln+='</item>'
    ...
    try:
        ...
        xbmc.executebuiltin("XBMC.Notification(Alive.HD,Please [COLOR yellow]install Youtube-dl[/COLOR] module ,15000,"")")
