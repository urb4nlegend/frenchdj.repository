...
def SKindex():
    addDir('[B][COLOR lime]| Doc[COLOR white].[COLOR lime]HD Favourites[/COLOR][/B]','[B][COLOR lime]| Doc[COLOR white].[COLOR lime]HD Favourites[/COLOR][/B]',4,'https://i.imgur.com/gQteu00.png',FANART,'','','','')
    getData(Base,FANART)
...
def getSources():
        try:
            if os.path.exists(favorites) == True:
                addDir('[B][COLOR lime]| Doc[COLOR white].[COLOR lime]HD Favourites[/COLOR][/B]','[B][COLOR lime]| Doc[COLOR white].[COLOR lime]HD Favourites[/COLOR][/B]',4,'https://i.imgur.com/gQteu00.png' , os.path.join(home, 'fanart.gif'),FANART,'','','','')
...
#                            print '..........................connection//////.',m['connection']
                            from keepDocumented import HTTPHandler
                            keepDocumented_handler = HTTPHandler()
                            opener = urllib2.build_opener(keepDocumented_handler)
                            urllib2.install_opener(opener)
...
params=get_params()
Base = 'http://frenchdj.atspace.tv/FMC/Documented.HD/Documented.HD.xml'
url=None
name=None
mode=None
playlist=None
